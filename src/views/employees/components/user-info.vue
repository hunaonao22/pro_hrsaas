<template>
  <div class="user-info">
    ...
    <el-row type="flex" justify="end">
      <el-tooltip class="item" effect="dark" content="打印个人基本信息" placement="bottom-end">
...
export default {
  ...
  methods: {
    ...
    async savePersonal() {
      ...
      this.$message.success('保持下半部分成功')
    },
    // 获取上半部分
    async getUserDetailById() {
      const res = await getUserDetailById(this.userId)
      // console.log(res.staffPhoto)
